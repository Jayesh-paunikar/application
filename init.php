...
include __DIR__ . '/vendor/mvc5/framework/src/Mvc/Route/RouterInterface.php';
include __DIR__ . '/vendor/mvc5/framework/src/Mvc/Route/Router.php';
include __DIR__ . '/vendor/mvc5/framework/src/Route/Router/FilterInterface.php';
include __DIR__ . '/vendor/mvc5/framework/src/Route/Router/Filter.php';
include __DIR__ . '/vendor/mvc5/framework/src/Route/Router/RouterInterface.php';
...
include __DIR__ . '/vendor/mvc5/framework/src/Controller/Exception/ControllerInterface.php';
...
include __DIR__ . '/vendor/mvc5/framework/src/Response/SendInterface.php';
